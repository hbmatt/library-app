...
addBookToLibrary(new Book('The Queen of Attolia', 'Megan Whalen Turner', 280, 'Read'));
addBookToLibrary(new Book('The King of Attolia', 'Megan Whalen Turner', 397, 'Read'));
addBookToLibrary(new Book('Thick As Thieves', 'Megan Whalen Turner', 352, 'Read'));
displayLibrary();